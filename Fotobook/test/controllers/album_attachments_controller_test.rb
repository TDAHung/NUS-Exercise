...
class AlbumAttachmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create album_attachment" do
    assert_difference("AlbumAttachment.count") do
      post album_attachments_url, params: { album_attachment: { album_id: @album_attachment.album_id, img_url: @album_attachment.img_url } }
    end
  ...
  test "should update album_attachment" do
    patch album_attachment_url(@album_attachment), params: { album_attachment: { album_id: @album_attachment.album_id, img_url: @album_attachment.img_url } }
